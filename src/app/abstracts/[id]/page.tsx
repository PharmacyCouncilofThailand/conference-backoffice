    ...
    return (
      <AdminLayout title="Abstract Details">
        <div className="flex justify-center items-center py-20">
          <IconLoader2 size={48} className="animate-spin text-emerald-600" />
        </div>
      </AdminLayout>
    );
  }
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="card">
            ...
            {abstract.keywords && (
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="text-emerald-600">{abstract.keywords}</span>
              </div>
            )}
          </div>
          ...
          <div className="space-y-4">
            <h2 className="text-lg font-semibold text-zinc-800 flex items-center gap-2">
              <IconFileText size={20} className="text-zinc-500" />
              Abstract Content
            </h2>

            {/* Background */}
            <div className="bg-zinc-50 border border-zinc-200 rounded-xl p-5">
              <h3 className="font-semibold text-zinc-600 mb-3 text-base">
                Background
              </h3>
              ...
              <div className="space-y-3">
                {attachedFiles.map((file, index) => (
                  <div
                    ...
                    className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 rounded-lg border border-zinc-200 bg-zinc-50 p-4"
                  >
                      ...
                      <div className="mt-3 space-y-2">
                        {request.files.map((file) => (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex max-w-full items-center gap-2 rounded-lg bg-white px-3 py-2 text-sm font-medium text-emerald-600 hover:text-emerald-700 border border-teal-100"
                          >
            ...
            <div className="space-y-3 text-sm">
              ...
              {abstract.author.phone && (
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-zinc-600">{abstract.author.phone}</span>
                </div>
              )}
            ...
            <div className="card">
              ...
              <div className="space-y-3">
                {abstract.coAuthors.map((ca, idx) => (
                  <div
                    key={ca.id}
                    className="p-3 bg-zinc-50 rounded-lg text-sm"
                  >
                    <div className="font-medium text-zinc-800">
                      {idx + 1}. {ca.firstName} {ca.lastName}
                    </div>
                    <div className="text-zinc-500">{ca.email}</div>
          ...
          <div className="card">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center justify-between py-2 border-b border-zinc-100">
                ...
                <span className="font-medium text-right text-zinc-800">
